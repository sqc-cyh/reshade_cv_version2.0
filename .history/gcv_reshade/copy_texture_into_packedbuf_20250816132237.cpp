	...
	TextureInterpretation tex_interp, const depth_tex_settings &depth_settings)
{
	...
	else
	{
        ...
        cmd_list->barrier(tex, resource_usage::depth_stencil, resource_usage::copy_source);
        cmd_list->copy_texture_region(tex, 0, nullptr, intermediate, 0, nullptr);
        cmd_list->barrier(tex, resource_usage::copy_source, resource_usage::depth_stencil);1
    }
