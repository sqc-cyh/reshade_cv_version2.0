...
# 用法示意（替换为你两帧路径）
Di,Mi = load(r'F:\SteamLibrary\steamapps\common\Grand Theft Auto V\cv_saved\GTAV_2025-08-30_2057837496_depth.npy'); Dj,Mj = load(r'F:\SteamLibrary\steamapps\common\Grand Theft Auto V\cv_saved\GTAV_2025-08-30_216898244_depth.npy')
for mode in ['c2w','w2c']:
