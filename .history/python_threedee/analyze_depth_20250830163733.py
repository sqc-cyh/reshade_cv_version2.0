...
def main():
    # GTAV文件列表（请替换为实际文件路径）
    gtav_files = [
        ""F:\SteamLibrary\steamapps\common\Grand Theft Auto V\cv_saved\GTAV_2025-08-30_101126877_meta.json"",
        "F:\\SteamLibrary\\steamapps\\common\\Grand Theft Auto V\\cv_saved\\GTAV_2025-08-30_143750125_meta.json",
        "F:\\SteamLibrary\\steamapps\\common\\Grand Theft Auto V\\cv_saved\\GTAV_2025-08-30_2057837496_meta.json",
        "F:\\SteamLibrary\\steamapps\\common\\Grand Theft Auto V\\cv_saved\\GTAV_2025-08-30_216898244_meta.json"
    ]
