...
def main():
    # GTAV文件列表（请替换为实际文件路径）
    gtav_files = [
        r"E:\steam\steamapps\common\Cyberpunk 2077\bin\x64\cv_saved\actions_2025-08-28_288796023\frame_000000_camera.json",
        r"E:\steam\steamapps\common\Cyberpunk 2077\bin\x64\cv_saved\actions_2025-08-28_288796023\frame_000023_camera.json"
    ]
