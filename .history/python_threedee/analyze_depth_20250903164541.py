...
# 你的 .npy 文件路径
file_path = r"E:\steam\steamapps\common\Cyberpunk 2077\bin\x64\cv_saved\Cyberpunk2077_2025-09-03_105804985_depth.npy"
try:
    # 加载 .npy 文件
    data = np.load(file_path)
    data = data.astype(np.float64) / 1073741824.0
    # 打印数组的形状（维度）
