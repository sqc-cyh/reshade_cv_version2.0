...
# --- 使用示例 ---
# 假设您在距离目标 20 米处捕获了文件
distance_meters = 0.78
vi_value, float_depth = get_center_depth('F:\SteamLibrary\steamapps\common\Grand Theft Auto V\cv_saved\GTAV_2025-08-29_734443594_depth.npy')
