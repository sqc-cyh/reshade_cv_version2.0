...
struct __declspec(uuid("bab8ffb9-5e8b-4b48-b4f2-4bac4bf87e82")) segmentation_app_data : public segmentation_app_buffer_indexing_colorization {
	...
	// 运行时是否启用 glassmask.fx::GlassMask（在 finish_effects 中刷新）
bool glassmask_on = false;

// 玻璃 ShaderID 集合；键为 (shaderID_hi, shaderID_lo)
struct PairHash {
...
// 载入 glass_ids.json：支持 "0x..._0x..." 字符串或 [hi, lo] 数组
