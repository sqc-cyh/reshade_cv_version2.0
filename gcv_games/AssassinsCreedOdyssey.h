...
class GameAssassinsCreedOdyssey : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "AssassinsCreedOdyssey"; }
...
REGISTER_GAME_INTERFACE(GameAssassinsCreedOdyssey, 0, "acodyssey.exe");
