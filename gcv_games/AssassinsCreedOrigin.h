...
class GameAssassinsCreedOrigin : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "AssassinsCreedOrigin"; }
...
REGISTER_GAME_INTERFACE(GameAssassinsCreedOrigin, 0, "acorigins.exe");
