...
class GameAssassinsCreedShadows : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "AssassinsCreedShadGameAssassinsCreedShadows"; }
...
REGISTER_GAME_INTERFACE(GameAssassinsCreedShadows, 0, "acshadows.exe");
