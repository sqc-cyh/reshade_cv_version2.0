...
class GameHogwartsLegacy : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "HogwartsLegacy"; }
...
REGISTER_GAME_INTERFACE(GameHogwartsLegacy, 0, "hogwartslegacy.exe");
