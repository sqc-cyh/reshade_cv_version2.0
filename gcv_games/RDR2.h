...
class GameRDR2 : public GameWithCameraDataInOneDLL{
public:
    virtual std::string gamename_simpler() const override { return "RDR2"; }
...
REGISTER_GAME_INTERFACE(GameRDR2, 0, "rdr2.exe");