...
class GameStray : public GameWithCameraDataInOneDLL {
protected:
...
public:
	virtual std::string gamename_simpler() const override { return "Stray"; }
...
REGISTER_GAME_INTERFACE(GameStray, 0, "stray-win64-shipping.exe");
